<template>
  <div class="q-mt-lg">
    <div class="font-domine subtitle fw-500 text-primary">Email Subscriptions</div>
    <div class="q-my-md font-montserrat text-primary fs-16 fw-500">You can manage your email subscriptions here. To unsubscribe from an email, uncheck the box next to it and save your changes below.</div>
